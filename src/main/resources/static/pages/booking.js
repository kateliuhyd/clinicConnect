/**
 * This file contains all the logic for the multi-step appointment booking page.
 */
function initBookAppointmentPage() {
    ...
    confirmSection.on('click', '#book-now-btn', function() {
        ...
        const formattedTime = hour.toString().padStart(2, '0') + ':' + timeParts[2] + ':00';
        const appointmentTimestamp = `${selectedDate}T${formattedTime}`;
